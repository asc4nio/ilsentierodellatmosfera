// GPT ARRAY OF STRINGS

export const TAPPE = {
  1: {
    titolo: "Cimone, la montagna che annusa il mondo",
    contenuto: [
  ...
  2: {
    titolo: "Un Osservatorio tra cielo e terra",
    contenuto: [
  ...
  3: {
    titolo: "I ricercati dell’atmosfera",
    contenuto: [
  ...
  4: {
    titolo: "Effetto serra non è una brutta parola",
    contenuto: [
  ...
  5: {
    ...
    approfondimento:
      "Verrà spiegato che il 1958 è un passaggio a misurazioni dirette e dando alcune informazioni in merito ad alcuni momenti chiave nell’evoluzione di questi grafici. Spiegare la misurazione diretta e indiretta della CO2 e il legame con l’aumento delle Temperatura.",
  },
  6: {
    titolo: "Montagne in crisi / Troppo caldo in montagna",
    contenuto: [
    ...
    approfondimento:
      "Spiegazione delle risposte appena viste raggruppate in: Eventi meteo estremi – Fusione di ghiacci e neve – Crisi delle riserve d’acqua – Perdita biodiversità",
  },
  7: {
    titolo: "Non solo CO2",
    contenuto: [
    ...
    approfondimento:
      "Cos’è il tempo di vita medio. L’inquinamento che ha due facce della stessa medaglia: uno sulla nostra salute e uno sul clima.",
  },
  8: {
    titolo: "Perché guardiamo il black carbon",
    contenuto: [
    ...
    approfondimento:
      "il black carbon un trend in calo (effetti positivi politiche europee). Ma attenzione: va lontano e viaggia in tutto il mondo. Himalaya.",
  },
  9: {
    titolo: "Buco dell’ozono: (quasi) risolto",
    contenuto: [
  ...
  10: {
    titolo: "La soluzione: un’alleanza tra scienza, politica e cittadini ",
    contenuto: [
    ...
    approfondimento: "Protocollo di Montereal.",
  },
};
...
export const TAPPE = {
  1: {
    titolo: "Cimone, la montagna che annusa il mondo",
    contenuto:
      "Il Monte Cimone è una stazione di monitoraggio atmosferico fondamentale per studiare l'impatto dell'uomo sul clima. Parte di una rete globale di 13 stazioni GAW in alta quota, è la prima in Europa e l’unica nel Mediterraneo. Questi punti di osservazione sono cruciali per comprendere come le attività umane stiano cambiando l'atmosfera. Grazie alla sua posizione unica, il Cimone raccoglie dati essenziali per monitorare le variazioni climatiche e atmosferiche. Queste misurazioni ci aiutano a capire meglio il riscaldamento globale e come possiamo intervenire per mitigarlo.",
    quiz: {
      type: "dnd",
  ...
  2: {
    titolo: "Un Osservatorio tra cielo e terra",
    contenuto:
      "Un osservatorio ad alta quota, come quello situato sul Monte Cimone, offre una visione privilegiata sia della terra che dell'atmosfera. Da questa posizione, si possono studiare fenomeni atmosferici importanti come le variazioni nella troposfera e lo strato di rimescolamento, che influiscono sul clima e sulla qualità dell'aria. Grazie alla collaborazione tra il CNR e l’Aeronautica Militare, l’Osservatorio è in grado di monitorare le condizioni atmosferiche in modo dettagliato. Questo permette di osservare anche la formazione delle nubi, offrendo dati preziosi per comprendere meglio i processi che influenzano il nostro ambiente.",
    quiz: {
      type: "sort",
      titolo:
        "La natura dell’Osservatorio (CNR + AM). La troposfera e lo strato di rimescolamento (cenni nubi).",
  ...
  3: {
    titolo: "I ricercati dell’atmosfera",
    contenuto:
      "L’impatto dell’uomo sull’atmosfera è immediato e rilevabile attraverso l’analisi di molecole invisibili che influenzano la salute del pianeta. Queste specie chimiche, spesso emesse da attività umane, possono alterare il clima e la qualità dell’aria in modi sottili ma significativi. Misurare la concentrazione di queste molecole permette di monitorare lo stato dell’atmosfera e comprendere meglio come le attività umane stiano contribuendo al cambiamento climatico. Riconoscere e classificare queste sostanze è fondamentale per mantenere sotto controllo la salute del nostro ambiente.",
    quiz: {
      type: "dnd",
  ...
  4: {
    titolo: "Effetto serra non è una brutta parola",
    contenuto:
      "L’effetto serra è un processo naturale fondamentale per la regolazione del clima terrestre. Senza di esso, la temperatura media del pianeta sarebbe molto più bassa, rendendo la Terra inabitabile per molte forme di vita. È grazie a questo fenomeno che il calore del sole viene trattenuto nell’atmosfera, mantenendo una temperatura stabile. Sebbene il termine sia spesso associato a connotazioni negative, l’effetto serra è essenziale per la vita sulla Terra. Il problema sorge quando le attività umane intensificano questo processo, causando un surriscaldamento e portando ai cambiamenti climatici.",
    quiz: {
      type: "question",
      titolo: "Indovina la temperatura media terrestre senza l’effetto serra ",
    },
  ...
  5: {
    titolo: "La Terra si scalda",
    contenuto:
      "I gas serra, come la CO2, hanno un impatto concreto sul riscaldamento globale. L’aumento delle loro concentrazioni nell’atmosfera è strettamente collegato al surriscaldamento del pianeta, con conseguenze visibili sul clima e sugli ecosistemi.Dal 1958, grazie a misurazioni dirette, possiamo tracciare con precisione l’aumento dei livelli di CO2. Questi dati ci mostrano chiaramente come l’incremento dei gas serra sia legato all'aumento delle temperature globali, segnando un trend preoccupante per il futuro del nostro pianeta.",
    quiz: {
      type: "sort",
      titolo: "Metti nell’ordine giusto le porzioni di grafico.",
    },
  ...
  6: {
    titolo: "Montagne in crisi / Troppo caldo in montagna",
    contenuto:
      "Il cambiamento climatico sta avendo un impatto diretto sugli ecosistemi montani, minacciando il loro equilibrio. L’aumento delle temperature nelle aree di alta quota sta accelerando la fusione di ghiacci e neve, con gravi conseguenze per le riserve d’acqua che dipendono da queste risorse. Oltre alla fusione dei ghiacciai, le montagne stanno affrontando eventi meteorologici estremi e una perdita di biodiversità, poiché molte specie non riescono ad adattarsi al rapido cambiamento delle condizioni ambientali. Questi effetti mettono a rischio la stabilità degli ecosistemi montani e delle comunità che da essi dipendono.",
    quiz: {
      type: "question",
      titolo:
        "quali effetti si prevede si verificheranno con la crisi del clima?",
  ...
  7: {
    titolo: "Non solo CO2",
    contenuto:
      "Oltre alla CO2, anche altri tipi di inquinamento atmosferico influenzano il clima. Sostanze come metano, ossidi di azoto e particolato contribuiscono al riscaldamento globale e hanno impatti significativi sull’equilibrio climatico e sulla qualità dell’aria che respiriamo. Questi inquinanti hanno tempi di vita diversi nell'atmosfera, influenzando sia la nostra salute che il clima. Comprendere come agiscono e per quanto tempo restano in circolazione è fondamentale per affrontare entrambe le facce del problema: la protezione del pianeta e del benessere umano.",
    quiz: {
      type: "dnd",
      titolo: "Trascina la durata corretta su ogni elemento",
    },
  ...
  8: {
    titolo: "Perché guardiamo il black carbon",
    contenuto:
      "Perché provoca problemi alla salute, al clima e alla criosfera. Ma chi lo emette?",
    quiz: {
      type: "question",
      titolo: "Tra queste illustrazioni scegli: chi emette Black Carbon?",
    },
  ...
  9: {
    titolo: "Buco dell’ozono: (quasi) risolto",
    contenuto:
      "Il buco dell'ozono si sta finalmente richiudendo, un risultato positivo ottenuto grazie alla collaborazione tra politica, scienza e cittadini. Gli sforzi congiunti hanno portato a una riduzione significativa delle sostanze che lo danneggiano. Un passaggio chiave è stato la sostituzione dei clorofluorocarburi (CFC), responsabili del deterioramento dell’ozono, con gli idrofluorocarburi (HFC), una nuova generazione di gas meno nocivi. Grazie a queste misure, l'atmosfera sta gradualmente recuperando, dimostrando l'efficacia delle politiche ambientali e la responsabilità condivisa.",
    quiz: {
      type: "dnd",
      titolo: "Trascina la molecola sulla propria ’azione",
    },
  ...
  10: {
    titolo: "La soluzione: un’alleanza tra scienza, politica e cittadini ",
    contenuto:
      "Affrontare la crisi climatica richiede un impegno collettivo che coinvolga scienziati, politici e cittadini. Ognuno di noi ha un ruolo da svolgere nella riduzione delle emissioni di CO2 e nella protezione del nostro ambiente. È fondamentale unire le forze per attuare strategie efficaci che possano portare a un futuro sostenibile. Le azioni che possiamo intraprendere, sia a livello individuale che collettivo, sono cruciali per combattere il cambiamento climatico. Dalla promozione di energie rinnovabili alla riduzione degli sprechi, ogni passo conta per costruire un'alleanza forte e coesa contro questa emergenza globale.",
    quiz: {
      type: "question",
      titolo:
        "Tra le azioni presentate scegli quelle che contribuiscono alla riduzione delle emissioni di CO2",
  ...
  //   contenuto:
  //     "Il sentiero dell’atmosfera evoca la via della conoscenza che sta percorrendo l’umanità per risolvere la crisi dell’atmosfera. Consapevolezza e soluzioni. Ora puoi unirti alle migliaia di escursionisti che ogni anno percorrono questo sentiero",
  //   quiz: "",
  //   approfondimento: "",
  // },
};
...
//     titolo: "Cimone, la montagna che annusa il mondo",
//     contenuto:
//       "L’uomo sta cambiando l’atmosfera e il clima. L’importanza della misura per comprenderlo e cambiare direzione. Le 13 stazioni GAW in alta quota. Unicità del Cimone: prima stazione d’Europa, unica in Italia e nel bacino mediterraneo.",
//     quiz: {
//       type: "dnd",
//       titolo: "Trascina i nomi/bandiere nei rispettivi riquadri.",
//     },
...
//   2: {
//     titolo: "Un Osservatorio tra cielo e terra",
//     contenuto: "Cosa può guardare un osservatorio ad alta quota",
//     quiz: {
//       type: "sort",
//       titolo:
//         "La natura dell’Osservatorio (CNR + AM). La troposfera e lo strato di rimescolamento (cenni nubi).",
...
//     titolo: "I ricercati dell’atmosfera",
//     contenuto:
//       "l’impatto dell’uomo appare subito in atmosfera. La salute dell’atmosfera si misura cercando molecole invisibili",
//     quiz: {
//       type: "dnd",
//       titolo: "Trascina le specie chimiche nel gruppo giusto.",
//     },
...
//   4: {
//     titolo: "Effetto serra non è una brutta parola",
//     contenuto: "L’effetto serra, la base del clima",
//     quiz: {
//       type: "question",
//       titolo: "Indovina la temperatura media terrestre senza l’effetto serra ",
//     },
...
//   5: {
//     titolo: "La Terra si scalda",
//     contenuto: "I gas serra hanno un effetto concreto. Come la CO2",
//     quiz: {
//       type: "sort",
//       titolo: "Metti nell’ordine giusto le porzioni di grafico.",
//     },
...
//     titolo: "Montagne in crisi / Troppo caldo in montagna",
//     contenuto:
//       " Il cambiamento climatico si riflette anche sugli ecosistemi montani.",
//     quiz: {
//       type: "question",
//       titolo:
//         "quali effetti si prevede si verificheranno con la crisi del clima?",
...
//   7: {
//     titolo: "Non solo CO2",
//     contenuto: "Non solo CO2: anche l’inquinamento impatta sul clima.",
//     quiz: {
//       type: "dnd",
//       titolo: "Trascina la durata corretta su ogni elemento",
//     },
...
//     titolo: "Buco dell’ozono: (quasi) risolto",
//     contenuto:
//       "Il buco dell’ozono si sta richiudendo, grazie a una collaborazione positiva tra politica, scienza e cittadini. Sostituzione tra CFC e HFC (vecchia e nuova generazione).",
//     quiz: {
//       type: "dnd",
//       titolo: "Trascina la molecola sulla propria ’azione",
//     },
...
//     titolo: "La soluzione: un’alleanza tra scienza, politica e cittadini ",
//     contenuto:
//       "Anche per la crisi climatica c’è bisogno del contributo di tutti.",
//     quiz: {
//       type: "question",
//       titolo:
//         "Tra le azioni presentate scegli quelle che contribuiscono alla riduzione delle emissioni di CO2",
